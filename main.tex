...
\small
$\sim$10 notebook launches/minute \\
\ ??? cell evaluations/minute

\vspace{0.2 cm}
served by 5 VMs worldwide
...
\includegraphics[height=3 cm]{binder-launches.png}\mbox{ }\includegraphics[height=3 cm]{binder-utilization.png}
\end{columns}
\end{uncoverenv}
\end{frame}
